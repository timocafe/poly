...
BOOST_AUTO_TEST_CASE(test_bd2bd2bd2bd2ed2_test){
    ...
    rms/=100;
    std::cout << "test_bd2bd2bd2bd2ed2" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
