//
// test_hkth1d2hkth1d2hkth1d2hkth1d2hkth1d2_test.cpp
//
// Created by Ewart Timothée, 15/2/2016
// Copyright (c) Ewart Timothée. All rights reserved.
//
// This file is generated automatically, do not edit!
// TAG: test_hkth1d2hkth1d2hkth1d2hkth1d2hkth1d2
// Helper:
...
BOOST_AUTO_TEST_CASE(test_hkth1d2hkth1d2hkth1d2hkth1d2hkth1d2_test){
    ...
    for (int i = 0; i < 1000; ++i){
        ...
        double y = poly::horner_kth<poly::coeffP2_1,1>(x)*poly::horner_kth<poly::coeffP2_2,1>(x)*poly::horner_kth<poly::coeffP2_3,1>(x)*poly::horner_kth<poly::coeffP2_4,1>(x)*poly::horner_kth<poly::coeffP2_5,1>(x)* (*(double *)(&twok));
    ...
    rms/=100;
    std::cout << "test_hkth1d2hkth1d2hkth1d2hkth1d2hkth1d2" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
