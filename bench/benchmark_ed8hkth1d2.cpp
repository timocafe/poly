...
#include "poly/poly.h"
   ...
   static inline uint64_t as_uint64(double x) {
    ...
    double poly_exp(double x){
        ...
        double y = poly::estrin<poly::coeffP8>(x)*poly::horner_kth<poly::coeffP2_5,1>(x)* (*(double *)(&twok));
...
int main(int argc, char* argv[]){
        ...
        std::cout << " benchmark_ed8hkth1d2, TROUGHPUT: " <<  freq*elapsed_seconds_poly_exp.count()/n << std::endl;
}
