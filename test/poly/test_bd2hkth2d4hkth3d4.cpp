...
BOOST_AUTO_TEST_CASE(test_bd2hkth2d4hkth3d4_test){
    ...
    for (int i = 0; i < 1000; ++i){
        ...
        double y = poly::bruteforce<poly::coeffP2_5>(x)*poly::horner_kth<poly::coeffP4_1,2>(x)*poly::horner_kth<poly::coeffP4_2,3>(x)* (*(double *)(&twok));
    ...
    rms/=100;
    std::cout << "test_bd2hkth2d4hkth3d4" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
