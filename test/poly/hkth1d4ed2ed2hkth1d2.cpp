...
BOOST_AUTO_TEST_CASE(hkth1d4ed2ed2hkth1d2_test){
    ...
    rms/=100;
    std::cout << "hkth1d4ed2ed2hkth1d2" << " rms :"  << std::sqrt(rms) <<  std::endl;
}
