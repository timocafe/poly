...
BOOST_AUTO_TEST_CASE(test_ed4ed2ed2ed2_test){
    ...
    rms/=100;
    std::cout << "test_ed4ed2ed2ed2" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
