...
BOOST_AUTO_TEST_CASE(test_hkth2d6ed2hkth1d2_test){
    ...
    for (int i = 0; i < 1000; ++i){
        ...
        double y = poly::horner_kth<poly::coeffP6,2>(x)*poly::estrin<poly::coeffP2_4>(x)*poly::horner_kth<poly::coeffP2_5,1>(x)* (*(double *)(&twok));
    ...
    rms/=100;
    std::cout << "test_hkth2d6ed2hkth1d2" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
