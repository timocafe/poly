...
BOOST_AUTO_TEST_CASE(ed4ed2hkth1d2hkth1d2_test){
    ...
    rms/=100;
    std::cout << "ed4ed2hkth1d2hkth1d2" << " rms :"  << std::sqrt(rms) <<  std::endl;
}
