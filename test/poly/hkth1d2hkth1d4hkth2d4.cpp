...
BOOST_AUTO_TEST_CASE(hkth1d2hkth1d4hkth2d4_test){
    ...
    rms/=100;
    std::cout << "hkth1d2hkth1d4hkth2d4" << " rms :"  << std::sqrt(rms) <<  std::endl;
}
