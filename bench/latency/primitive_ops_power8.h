 ...
 *  other code.
 *
 *  NB: Use of "v", as opposed to "wf" or "v", asm constraint for vector
...
inline void consume(v4float v) { asm volatile ("" ::"v"(v)); }
inline void consume(v2double v) { asm volatile ("" ::"v"(v)); }
