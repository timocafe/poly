...
BOOST_AUTO_TEST_CASE(test_hkth1d2ed4ed4_test){
    ...
    for (int i = 0; i < 1000; ++i){
        ...
        double y = poly::horner_kth<poly::coeffP2_5,1>(x)*poly::estrin<poly::coeffP4_1>(x)*poly::estrin<poly::coeffP4_2>(x)* (*(double *)(&twok));
    ...
    rms/=100;
    std::cout << "test_hkth1d2ed4ed4" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
