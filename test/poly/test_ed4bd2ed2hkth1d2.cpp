...
BOOST_AUTO_TEST_CASE(test_ed4bd2ed2hkth1d2_test){
    ...
    rms/=100;
    std::cout << "test_ed4bd2ed2hkth1d2" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
