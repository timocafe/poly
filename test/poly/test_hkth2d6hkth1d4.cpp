...
BOOST_AUTO_TEST_CASE(test_hkth2d6hkth1d4_test){
    ...
    for (int i = 0; i < 1000; ++i){
        ...
        double y = poly::horner_kth<poly::coeffP6,2>(x)*poly::horner_kth<poly::coeffP4_3,1>(x)* (*(double *)(&twok));
    ...
    rms/=100;
    std::cout << "test_hkth2d6hkth1d4" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
