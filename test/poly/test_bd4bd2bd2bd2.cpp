...
BOOST_AUTO_TEST_CASE(test_bd4bd2bd2bd2_test){
    ...
    rms/=100;
    std::cout << "test_bd4bd2bd2bd2" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
