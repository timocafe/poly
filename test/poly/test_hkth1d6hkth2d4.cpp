...
BOOST_AUTO_TEST_CASE(test_hkth1d6hkth2d4_test){
    ...
    rms/=100;
    std::cout << "test_hkth1d6hkth2d4" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
