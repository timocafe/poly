...
BOOST_AUTO_TEST_CASE(test_hkth5d6bd2ed2_test){
    ...
    rms/=100;
    std::cout << "test_hkth5d6bd2ed2" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
