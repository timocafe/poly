...
BOOST_AUTO_TEST_CASE(hkth5d6hkth1d2hkth1d2_test){
    ...
    rms/=100;
    std::cout << "hkth5d6hkth1d2hkth1d2" << " rms :"  << std::sqrt(rms) <<  std::endl;
}
