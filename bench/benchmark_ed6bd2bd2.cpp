...
#include "poly/poly.h"
   ...
   static inline uint64_t as_uint64(double x) {
    ...
    double poly_exp(double x){
        ...
        double y = poly::estrin<poly::coeffP6>(x)*poly::bruteforce<poly::coeffP2_4>(x)*poly::bruteforce<poly::coeffP2_5>(x)* (*(double *)(&twok));
...
int main(int argc, char* argv[]){
        ...
        std::cout << " benchmark_ed6bd2bd2, TROUGHPUT: " <<  freq*elapsed_seconds_poly_exp.count()/n << std::endl;
}
