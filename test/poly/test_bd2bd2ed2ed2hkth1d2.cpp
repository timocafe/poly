...
BOOST_AUTO_TEST_CASE(test_bd2bd2ed2ed2hkth1d2_test){
    ...
    rms/=100;
    std::cout << "test_bd2bd2ed2ed2hkth1d2" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
