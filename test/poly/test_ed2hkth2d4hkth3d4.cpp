...
BOOST_AUTO_TEST_CASE(test_ed2hkth2d4hkth3d4_test){
    ...
    rms/=100;
    std::cout << "test_ed2hkth2d4hkth3d4" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
