...
#include "poly/poly.h"
   ...
   static inline uint64_t as_uint64(double x) {
    ...
    double poly_exp(double x){
        ...
        double y = poly::horner_kth<poly::coeffP6,2>(x)*poly::estrin<poly::coeffP4_3>(x)* (*(double *)(&twok));
...
int main(int argc, char* argv[]){
        ...
        std::cout << " benchmark_hkth2d6ed4, TROUGHPUT: " <<  freq*elapsed_seconds_poly_exp.count()/n << std::endl;
}
