...
BOOST_AUTO_TEST_CASE(hkth1d2hkth1d2hkth1d2hkth1d2hkth1d2_test){
    ...
    rms/=100;
    std::cout << "hkth1d2hkth1d2hkth1d2hkth1d2hkth1d2" << " rms :"  << std::sqrt(rms) <<  std::endl;
}
