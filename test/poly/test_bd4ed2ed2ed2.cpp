...
BOOST_AUTO_TEST_CASE(test_bd4ed2ed2ed2_test){
    ...
    rms/=100;
    std::cout << "test_bd4ed2ed2ed2" << " rms: "  << std::sqrt(rms) << " ulp: " << max << std::endl;
}
